...
const PopUp = ({refetch, userId, handleSubmit}) => {
  ...
  return (
    <>
        ...
        >
            <DeleteSvg className='absolute right-4.5 bottom-4'/>
        </button>

        {
            showConfirmModal && 
            <div id="popup-modal" tabIndex={-1}
            className="fixed top-50 right-0 left-100 z-50 justify-center items-center" 
            // className="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full"
            >
                <div className="p-4 w-full max-w-md max-h-full">
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-600 dark:text-gray-200">
                        <button
